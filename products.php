    ...
    <head>
      ...
      position: fixed;
      top: 0;
      right: -100%; /* nakatago muna sa kanan */
      width: 100%;
      height: 100%;
      ...
      align-items: center;
      transition: right 0.4s ease; /* swipe animation */
      z-index: 2000;
      }

      /* Kapag active lalabas */
...
.slide img:hover {
  transform: scale(1.1); /* konting dagdag zoom on hover */
}
...
.arrow.right { right: 15px; }
 ...
 <div class="hero-banner">
    <div class="slides">
      <div class="slide"><img src="assets/offtindex1.png" alt="Slide 1"></div>
      <div class="slide"><img src="assets/offtindex2.png" alt="Slide 2"></div>
      <div class="slide"><img src="assets/offtindex3.png" alt="Slide 3"></div>
      </div>
  ...
  <button class="arrow right">›</button>
      ...
      <div class="marquee-container">
        <div class="marquee-track">
          <span>ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • </span>
          <span>ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME •</span>
          <span>ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME • ALL EYEZ ON ME •</span>
        </div>
      </div>
